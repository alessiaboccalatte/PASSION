...
if not model_path.exists():
    print(f'Rooftop segmentation model was not found. Downloading it from {SECTION_MODEL_URL}. If the file exists, please check the location in the config.yml file.')
